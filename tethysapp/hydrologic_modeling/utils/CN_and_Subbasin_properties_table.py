#-------------------------------------------------------------------------------
# Name:        Subbasin_properties_table
# Purpose:     Create a table for subbasins containing different characteristics
#
...
if subbasin == "":
    NLCD = r"E:\Research Data\00 Red Butte Creek\RBC_demo2\Raw_files.gdb\NLCD_c"
    HSG = r"E:\Research Data\RBC_demo_uwrl\SSURGO_rasters\TEMP\hsg_soilx"
    CN_lut = "CN_LUT_NLCD_HSG.csv"
    subbasin = r"E:\Research Data\RBC_demo_uwrl\Raw_files.gdb\CatchPoly"
    raster_folder = r"E:\Research Data\RBC_demo_uwrl\TIFFS"
